          ...
          <div className="md:col-span-5 space-y-10">
            ...
            <FadeUp delay={0.1}>
              <div>
                ...
                <a href="mailto:hello@mithunraj.dev" data-cursor="pointer" className="text-xl md:text-2xl font-display font-semibold text-foreground hover:text-primary transition-colors duration-500">
                  hello@mithunraj.dev
                </a>
              </div>
            </FadeUp>
            ...
            <form onSubmit={handleSubmit} className="glass-panel glow-border p-8 md:p-10 space-y-6">
              ...
              <Magnetic>
                <button
                  type="submit"
                  data-cursor="pointer"
                  className="group flex items-center gap-3 mt-4 text-sm font-heading tracking-wider uppercase text-foreground hover:text-primary transition-colors duration-500"
                >
                  Send Message
